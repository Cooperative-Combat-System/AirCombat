...
python train/train_jsbsim.py --env-name "SingleControl" --algorithm-name "ppo" --scenario-name "1/heading" --experiment-name "v1" --seed 5 --n-training-threads 1 --n-rollout-threads 32 --cuda --log-interval 1 --save-interval 1 --num-mini-batch 5 --buffer-size 3000 --num-env-steps 3e7 --lr 3e-4 --gamma 0.99 --ppo-epoch 4 --clip-params 0.2 --max-grad-norm 2 --entropy-coef 1e-3 --hidden-size "128 128" --act-hidden-size "128 128" --recurrent-hidden-size 128 --recurrent-hidden-layers 1 --data-chunk-length 8